...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public void setStockerDAO(StockerDAO stockerDAO) {
        this.stockerDAO = stockerDAO;
    }
    ...
    public UserDetails loadUserByUsername(String username)
        ...
        try {
            ...
            DbUser dbUser = stockerDAO.getUserByUsername(username);
